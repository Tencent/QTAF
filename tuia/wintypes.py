# -*- coding: utf-8 -*-
#10/11/18 aaronlai    created
#10/12/21 aaronlai    增加PROCESSENTRY32结构
#13/02/28 eeelin      增加MODULEENTRY32
import ctypes
import win32con
import os
...
class TBBUTTON(ctypes.Structure):
    ...
    #2013/06/20 aaronlai    修改TBButton的结构，会根据操作系统位数修改
    _fields_ = [
