# Contributing to QTAF
Welcome to [report Issues](https://github.com/Tencent/QTAF/issues) or [pull requests](https://github.com/Tencent/QTAF/pulls). It's recommended to read the following Contributing Guild first to make contributing earlier. 
...
## Pull Requests
We strongly welcome your pull request to make QTAF better. 
...
## License
By contributing to QTAF, you agree that your contributions will be licensed
under its [BSD LICENSE](https://github.com/Tencent/QTAF/blob/master/LICENSE)